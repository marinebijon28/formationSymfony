...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions 
    {
        ...
        $updateDelivry = Action::new('updateDelivery', 'Livraison en cours', 'fas fa-truck')->linkToCrudAction('updateDelivery');
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $this->addFlash('notice', '<span style="color:orange;"<strong>La commande ' . $order->getReference() . 
